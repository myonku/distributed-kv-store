...
func (x *LogEntry) Reset() {
	*x = LogEntry{}
	mi := &file_internal_raft_r_proto_msgTypes[0]
...
func (*LogEntry) Descriptor() ([]byte, []int) {
	return file_internal_raft_r_proto_rawDescGZIP(), []int{0}
}
...
func (x *AppendEntriesRequest) Reset() {
	*x = AppendEntriesRequest{}
	mi := &file_internal_raft_r_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEntriesRequest) Descriptor() ([]byte, []int) {
	return file_internal_raft_r_proto_rawDescGZIP(), []int{1}
}
...
func (x *AppendEntriesResponse) Reset() {
	*x = AppendEntriesResponse{}
	mi := &file_internal_raft_r_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendEntriesResponse) Descriptor() ([]byte, []int) {
	return file_internal_raft_r_proto_rawDescGZIP(), []int{2}
}
...
func (x *RequestVoteRequest) Reset() {
	*x = RequestVoteRequest{}
	mi := &file_internal_raft_r_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RequestVoteRequest) Descriptor() ([]byte, []int) {
	return file_internal_raft_r_proto_rawDescGZIP(), []int{3}
}
...
func (x *RequestVoteResponse) Reset() {
	*x = RequestVoteResponse{}
	mi := &file_internal_raft_r_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RequestVoteResponse) Descriptor() ([]byte, []int) {
	return file_internal_raft_r_proto_rawDescGZIP(), []int{4}
}
...
var File_internal_raft_r_proto protoreflect.FileDescriptor
...
var (
	...
	file_internal_raft_r_proto_rawDescData []byte
)

func file_internal_raft_r_proto_rawDescGZIP() []byte {
	file_internal_raft_r_proto_rawDescOnce.Do(func() {
		file_internal_raft_r_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_raft_r_proto_rawDesc), len(file_internal_raft_r_proto_rawDesc)))
	})
	return file_internal_raft_r_proto_rawDescData
}

var file_internal_raft_r_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_internal_raft_r_proto_goTypes = []any{
	(*LogEntry)(nil),              // 0: raft.v1.LogEntry
	(*AppendEntriesRequest)(nil),  // 1: raft.v1.AppendEntriesRequest
...
var file_internal_raft_r_proto_depIdxs = []int32{
	0, // 0: raft.v1.AppendEntriesRequest.entries:type_name -> raft.v1.LogEntry
	1, // 1: raft.v1.RaftService.AppendEntries:input_type -> raft.v1.AppendEntriesRequest
	3, // 2: raft.v1.RaftService.RequestVote:input_type -> raft.v1.RequestVoteRequest
	2, // 3: raft.v1.RaftService.AppendEntries:output_type -> raft.v1.AppendEntriesResponse
	4, // 4: raft.v1.RaftService.RequestVote:output_type -> raft.v1.RequestVoteResponse
...
func init() { file_internal_raft_r_proto_init() }
func file_internal_raft_r_proto_init() {
	if File_internal_raft_r_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_raft_r_proto_rawDesc), len(file_internal_raft_r_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_raft_r_proto_goTypes,
		DependencyIndexes: file_internal_raft_r_proto_depIdxs,
		MessageInfos:      file_internal_raft_r_proto_msgTypes,
	}.Build()
	File_internal_raft_r_proto = out.File
	file_internal_raft_r_proto_goTypes = nil
	file_internal_raft_r_proto_depIdxs = nil
}
